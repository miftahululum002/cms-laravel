...
export default function LinkButton({
    ...
    return (
        <Link
            {...props}
            className={
                "inline-flex items-center px-4 rounded-none border border-transparent text-sm font-medium transition ease-in-out duration-150 focus:outline-none focus:ring-2" +
                (active
